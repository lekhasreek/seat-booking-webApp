  ...
  return (
    <div className="minimap-container">
      ...
      >
        ...
        <rect data-workspace="B" x="325" y="19" width="58" height="63" rx="3" transform="rotate(90 325 19)" className="overlay-shape" />
        <rect data-workspace="B" x="325" y="109" width="120" height="37" rx="3" transform="rotate(180 325 109)" className="overlay-shape" />
        <rect data-workspace="D" x="755" y="18" width="91" height="58" rx="3" transform="rotate(90 755 18)" className="overlay-shape" />
        <rect data-workspace="C" x="637" y="109" width="105" height="90" rx="3" transform="rotate(180 637 109)" className="overlay-shape" />

        <rect data-workspace="E" x="185" y="226" width="79" height="91" rx="3" transform="rotate(180 185 226)" className="overlay-shape" />
        <rect data-workspace="F" x="339" y="226" width="86" height="91" rx="3" transform="rotate(180 339 226)" className="overlay-shape" />
        <path data-workspace="G" d="M552 138C552 136.343 553.343 135 555 135H684C685.657 135 687 136.343 687 138V223C687 224.657 685.657 226 684 226H619.5H555C553.343 226 552 224.657 552 223V138Z" className="overlay-shape" />
